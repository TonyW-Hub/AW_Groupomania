        ...
        <div class="col-lg-7 offset-lg-3 mx-auto">
            <div class="row mx-auto">
                <div class="col-lg-8 mx-auto">
                    <div class="card my-3 border-primary mx-auto shadow">
                        <div class="card-header">
                            <h1 class="text-secondary">Post</h1>
                        </div>
                        <div>
                                ...
                                <div class="col">
                                    <form v-on:submit.prevent="createPost" enctype="multipart/form-data">
                                        <div class="form-group mb-0">
                                            ...
                                            <b-form-textarea name="content" type="text" v-model="content" class="form-control border-primary" id="content" rows="2" placeholder="Quoi de neuf aujourd'hui ?"></b-form-textarea>
            ...
            <b-alert v-if="blankPost" show dismissible variant="danger">Le champs est vide</b-alert>
        </div>
</template>
